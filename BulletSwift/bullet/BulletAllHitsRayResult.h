...
@interface BulletAllHitsRayResult : NSObject
@property (nonatomic, readonly) float closestHitFraction;
@property (nonatomic, readonly) vector_float3 from;
@property (nonatomic, readonly) vector_float3 to;

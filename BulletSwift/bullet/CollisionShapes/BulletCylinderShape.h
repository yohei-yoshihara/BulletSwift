...
@interface BulletCylinderShape : BulletCollisionShape
@property (nonatomic, readonly) vector_float3 halfExtentsWithMargin;
@property (nonatomic, readonly) vector_float3 halfExtentsWithoutMargin;
@property (nonatomic, readonly) float radius;
@property (nonatomic, readonly) float height;
@property (nonatomic, readonly) BulletUpAxis up;

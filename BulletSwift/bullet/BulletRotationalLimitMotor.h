...
@interface BulletRotationalLimitMotor : NSObject
@property (nonatomic) float lowerLimit;
@property (nonatomic) float upperLimit;
@property (nonatomic) float targetVelocity;
@property (nonatomic) float maxMotorForce;
@property (nonatomic) float maxLimitForce;
